...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "ship2aruba"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@ship2aruba.com")
EMAIL_TIMEOUT = 5
...
COMPANY_NAME = os.getenv("COMPANY_NAME", "Ship 2 Aruba")
COMPANY_ADDRESS = os.getenv("COMPANY_ADDRESS", "Wayaca 43C, Oranjestad, Aruba")
COMPANY_PHONE = os.getenv("COMPANY_PHONE", "592-4222")
